...
static btSimdScalar gResolveSingleConstraintRowGeneric_sse4_1_fma3(btSolverBody& body1, btSolverBody& body2, const btSolverConstraint& c)
{
	...
	__m128  deltaV = FMADD(c.m_contactNormal1.mVec128, body1.internalGetDeltaLinearVelocity().mVec128, FMADD(c.m_relpos1CrossNormal.mVec128, body1.internalGetDeltaAngularVelocity().mVec128,
					 FMADD(c.m_contactNormal2.mVec128, body2.internalGetDeltaLinearVelocity().mVec128, c.m_relpos2CrossNormal.mVec128 * body2.internalGetDeltaAngularVelocity().mVec128)));


	deltaImpulse = deltaImpulse - DOT_PRODUCT(deltaV, _mm_set_ps1(c.m_jacDiagABInv));

	__m128 tmp							= _mm_add_ps(c.m_appliedImpulse, deltaImpulse); // sum
